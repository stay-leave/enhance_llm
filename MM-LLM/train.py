...
from dataset.data import LlavaDataset, TrainLLavaModelCollator
from dataset.util import print_trainable_parameters
...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="autodl-tmp/vlm_1")
